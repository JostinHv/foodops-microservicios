...
readonly class TipoMovimientoCajaService implements ITipoMovimientoCajaService
{
    public function __construct(private ITipoMovimientoCajaRepository $repository) {}
